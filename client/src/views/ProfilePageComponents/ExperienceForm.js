...
import { Save, Plus, X, Trash2 } from "react-feather";
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {experience.description && (
                  <div className="sm:col-span-2">
                    <h4 className="text-sm font-medium text-gray-700 mb-2">Responsibilities Preview:</h4>
                    <ul className="list-disc pl-5 space-y-1">
                      {descriptionToBulletPoints(experience.description).map((point, index) => (
